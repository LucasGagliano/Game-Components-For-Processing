    ...
    public boolean CriarBotoes(PApplet processingSketch, char tipoBotao, PImage icone, float posicaoX, float posicaoY, float largura, float altura, String textoBotao, int tamanhoFonte)
    {
        ...
        switch (tipoBotao)
        {
            case 'i':
                ...
                retorno = processingSketch.mouseX >= posicaoX && processingSketch.mouseX <= posicaoX + largura && processingSketch.mouseY >= posicaoY && processingSketch.mouseY <= posicaoY + altura;
                break;
